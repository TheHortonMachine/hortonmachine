...
public class GpsInfoController extends GpsInfoView implements NmeaGpsListener, IOnCloseListener {
    ...
    private CurrentGpsPointLayer gpsPointLayer;
...
//    JTextField _satInfoCountText = new JTextField();
    ...
    */
    ...
    public GpsInfoController() {
        ...
        String[] availablePorts = SerialNmeaGps.getAvailablePorts();
        ...
        _gpsConnectButton.addActionListener(e -> {
            if (_gpsConnectButton.isSelected()) {
                ...
                _gpsConnectButton.setText(port);
                new Thread(new Runnable(){
                    public void run() {
        ...
        gpsPointLayer = new CurrentGpsPointLayer("GPS position", Color.RED, null, null, 20.0);
