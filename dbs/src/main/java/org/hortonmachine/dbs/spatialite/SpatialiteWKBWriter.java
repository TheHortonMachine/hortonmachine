 ...
 * @see WKBReader
 */
public class SpatialiteWKBWriter {
    /**
     ...
     */
    public SpatialiteWKBWriter( int outputDimension ) {
     ...
     */
    public SpatialiteWKBWriter( int outputDimension, int byteOrder ) {
     ...
     */
    private SpatialiteWKBWriter( int outputDimension, int byteOrder, boolean includeSRID ) {
...
//        }
    ...
    private void writeDouble( double doubleValue, OutStream os ) throws IOException {
        ByteOrderValues.putDouble(doubleValue, buf, byteOrder);
        os.write(buf, 8);
    }
