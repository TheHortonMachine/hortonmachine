...
import static eu.hydrologis.edc.utils.Constants.BASINTYPE;
...
/**
 * The basin type Table.
 * 
 * <p>
 * The table is used to define a basin type, as for example 
 * simple cell or triangular element.
 * </p>
 * 
 ...
 */
@Entity
@Table(name = BASINTYPE, schema = EDC_SCHEMA)
public class BasinTypeTable {
    /**
