 ...
 */
public class DataTypeDao extends AbstractEdcDao {

    public DataTypeDao( EdcSessionFactory edcSessionFactory ) {
    ...
    public String getRecordDefinition() throws Exception {
        ...
        sB.append(tableAnnotationToString(DataTypeTable.class)).append(": ");
        sB.append(columnAnnotationToString(DataTypeTable.class, "id")).append(", ");
        sB.append(columnAnnotationToString(DataTypeTable.class, "name")).append(", ");
        return sB.toString();
    }
}
