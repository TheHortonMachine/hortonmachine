 ...
 */
public class SoilTypeParametersDao extends AbstractEdcDao {

    public SoilTypeParametersDao( EdcSessionFactory edcSessionFactory ) {
        super(edcSessionFactory);
    }

    protected void processLine( String[] lineSplit ) {
        SoilTypeParametersTable gpT = new SoilTypeParametersTable();
    ...
    public String getRecordDefinition() throws Exception {
        ...
        sB.append(tableAnnotationToString(SoilTypeParametersTable.class)).append(": ");
        sB.append(columnAnnotationToString(SoilTypeParametersTable.class, "id")).append(", ");
        sB.append(columnAnnotationToString(SoilTypeParametersTable.class, "name")).append(", ");
        sB.append(columnAnnotationToString(SoilTypeParametersTable.class, "description")).append(
                ", ");
        sB.append(joinColumnAnnotationToString(SoilTypeParametersTable.class, "unit")).append(", ");
