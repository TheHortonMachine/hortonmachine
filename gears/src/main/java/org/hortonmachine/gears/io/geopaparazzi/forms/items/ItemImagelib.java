 ...
 */
public class ItemImagelib implements Item {

    public static final String TYPE = "imagelib";
    private String description;
    private boolean isMandatory;
    private String defaultValueStr;
    private String key;

    public ItemImagelib( String key, String description, String defaultValue, boolean isMandatory ) {
        this.key = key;
