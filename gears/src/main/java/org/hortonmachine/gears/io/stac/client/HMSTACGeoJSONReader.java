...
class HMSTACGeoJSONReader extends GeoJSONReader {

    private final HTTPClient http;

    public HMSTACGeoJSONReader(InputStream is, HTTPClient http) throws IOException {
        super(is);
        this.http = http;
    }
    ...
    protected PagingFeatureCollection getPagingFeatureCollection(
        ...
        return new HMSTACPagingFeatureCollection(result, next, matched, http);
    }
}
