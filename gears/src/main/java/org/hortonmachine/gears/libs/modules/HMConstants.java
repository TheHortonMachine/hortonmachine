...
public class HMConstants {
    ...
    */
    ...
    public static final String[] SUPPORTED_DB_EXTENSIONS = {EDb.SPATIALITE.getExtension(),EDb.SQLITE.getExtension(),EDb.MBTILES.getExtension(), EDb.H2GIS.getExtension(),
