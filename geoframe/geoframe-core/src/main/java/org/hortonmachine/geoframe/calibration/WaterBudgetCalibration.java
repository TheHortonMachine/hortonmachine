...
public class WaterBudgetCalibration {
	...
	public static void psoCalibration(int maxBasinId, double[] basinAreas, TopologyNode rootNode, String fromTS, String toTS,
		...
		double[][] ranges = new double[][] {
			RainSnowSeparationParameters.alphaRRange(),
			RainSnowSeparationParameters.alphaSRange(),
			RainSnowSeparationParameters.meltingTemperatureRange(),
			SnowMeltingParameters.combinedMeltingFactorRange(),
			SnowMeltingParameters.freezingFactorRange(),
			SnowMeltingParameters.alfaLRange(),
			WaterBudgetCanopyParameters.kcRange(),
			WaterBudgetCanopyParameters.pRange(),
			WaterBudgetRootzoneParameters.sRootZoneMaxRange(),
			WaterBudgetRootzoneParameters.gRange(),
			WaterBudgetRootzoneParameters.hRange(),
			WaterBudgetRootzoneParameters.pBSoilRange(),
			WaterBudgetRunoffParameters.sRunoffMaxRange(),
			WaterBudgetRunoffParameters.cRange(),
			WaterBudgetRunoffParameters.dRange(),
			WaterBudgetGroundParameters.sGroundWaterMaxRange(),
			WaterBudgetGroundParameters.eRange(),
			WaterBudgetGroundParameters.fRange()
		};
