...
public class i__smap {
	...
	@Description("Generated by i.gensigset")
	@In
	...
	@Description("Size of submatrix to process at one time (optional)")
	@In
	public String $$blocksizePARAMETER = "128";

	@Description("Use maximum likelihood estimation (instead of smap)")
	@In
