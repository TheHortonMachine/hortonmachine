...
public class r__li__edgedensity {
	...
	@Description("The value of the patch type, it can be integer, double or float; it will be changed in function of map type (optional)")
	@In
	public String $$patch_typePARAMETER;
