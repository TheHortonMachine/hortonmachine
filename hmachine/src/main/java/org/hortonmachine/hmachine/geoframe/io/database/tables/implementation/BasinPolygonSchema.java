 ...
 *
 * <p>
 * This table stores basin geometries as multipolygons and associated summary
 * attributes (typically derived from geomorphological analysis).
 *
 * <p>
 * Each record represents a basin with its geometric representation and
 * aggregated physical properties such as area, elevation...
 */
public final class BasinPolygonSchema extends GeoAbstractSchema {

	public BasinPolygonSchema() {
