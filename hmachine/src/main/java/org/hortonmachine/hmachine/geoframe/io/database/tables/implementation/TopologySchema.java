 ...
 *
 * <p>This table stores the topological relationships between basins,
 * linking each upstream basin to its corresponding downstream basin.</p>
 *
 * <p>Column definitions are centralized in the {@link TopologyField}
 * enumeration to ensure consistency between SQL generation and Java code.</p>
 *
