...
import eu.hydrologis.jgrass.hortonmachine.io.grass.spi.GrassBinaryImageReaderSpi;
import eu.hydrologis.jgrass.hortonmachine.utils.ByteUtilities;
...
public class JGrassMapEnvironment {
    ...
    public double[] getRangeFromMapScan() throws IOException {
        ...
        cell_miscRangeStream.write(ByteUtilities.double2bytearray(dataRange[0]));
        cell_miscRangeStream.write(ByteUtilities.double2bytearray(dataRange[1]));
