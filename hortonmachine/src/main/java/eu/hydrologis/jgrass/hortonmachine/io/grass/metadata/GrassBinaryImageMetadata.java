 ...
 */
package eu.hydrologis.jgrass.hortonmachine.io.grass.metadata;
...
import eu.hydrologis.jgrass.hortonmachine.io.grass.core.GrassBinaryRasterReadHandler;
...
public final class GrassBinaryImageMetadata extends IIOMetadata {
     ...
     * </p>
     */
    private double noData = HMConstants.doubleNovalue;

    /**
     * the size of a single cell of the raster grid along X.
     */
    private double xRes = HMConstants.doubleNovalue;

    /**
     * the size of a single cell of the raster grid along Y.
     */
    private double yRes = HMConstants.doubleNovalue;
