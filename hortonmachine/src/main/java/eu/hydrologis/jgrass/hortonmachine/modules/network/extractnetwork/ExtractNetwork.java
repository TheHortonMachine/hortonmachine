 ...
 */
package eu.hydrologis.jgrass.hortonmachine.modules.network.extractnetwork;
...
public class ExtractNetwork extends HMModel {
    ...
    private WritableRaster extractNetMode0( RenderedImage flowRI, RenderedImage tcaRI ) {
        ...
        WritableRaster netImage = CoverageUtilities.createDoubleWritableRaster(cols, rows, null, null, HMConstants.doubleNovalue);
    ...
    private WritableRaster extractNetMode1( RenderedImage flowRI, RenderedImage tcaRI, RenderedImage slopeRI ) {
        ...
        // create new RasterData for the network matrix
        WritableRaster networkWR = CoverageUtilities.createDoubleWritableRaster(cols, rows, null, null, HMConstants.doubleNovalue);
