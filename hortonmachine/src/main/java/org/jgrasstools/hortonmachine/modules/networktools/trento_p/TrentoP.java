 ...
 * </ol>
 * 
 * And as input a <b><i>FeatureCollection</i></b> {@link #inPipesFC} with
 ...
 * </p>
 * <p>
 * For more details about the computational method see {@link http
 * ://www.ing.unitn.it/dica/hp/?user=rigon}
 * </p>
 * 
 * @see {@link Pipe},{@link NetworkBuilder},{@link NetworkCalibration}.
...
public class TrentoP {
    ...
    /**
     * Monitor, which is used to print the percentage of the work and relative
     * messages.
     */
    ...
    /**
     * Max number of bisection to do to search a solution of a transcendently
     * equation.
     */
    @Description("Max number of bisection to do (default is 40).")
    @Unit("-")
    @Range(max = 1000, min = 3)
    @In
    public int pJMax = DEFAULT_J_MAX;
    /**
     * Accuracy to use to calculate a solution with bisection method.
     */
    @Description("Accuracy to use to calculate a solution.")
    @Unit("-")
    @Range(min = 0)
    @In
     ...
     */
    @Description("Exponent of the average ponderal slope of a basin to calculate the average access time to the network .")
    @Unit("-")
    @Range(min = 0)
    @In
    ...
    public Double pA;
    /**
     * Exponent of the pluviometric curve of possibility.
     */
    ...
    /**
     * Matrix which contains the commercial diameters of the pipes.
     */
     ...
     * The input network.
     * <p>
     * Usually it is obtained from a <i>shp file</i>. It's necessary that the
     * geometries of the shape are {@link LineString} and each line (which is a
     ...
     * is in ha = 10^{-2} km^2 ({@link TrentoP#fDrainArea}).
     * <li>initial Elevation of the terrain (at the first extreme), is in meter
     * over the see level ({@link TrentoP#fInitialElevation}).
     * <li>Final Elevation of the terrain(at the second extreme), is in meter
     * over the see level ({@link TrentoP#fFinalElevation}).
     * <li>The Runoff coefficient ({@link TrentoP#fRunoffCoefficient}).
     * <li>The average residence time,per unit area (
     * {@link TrentoP#fAverageResidenceTime}).
     * <li>Ks, Gauckler-Strickler coefficient({@link TrentoP#fKs}).
     * <li>Minimum pipe slope (%),({@link TrentoP#fMinimumPipeSlope}).
     * <li>Pipe section type: 1=circular, 2=rectangular, 3=trapezoidal,(
     * {@link TrentoP#fPipeSectionType} ).
     ...
     * {@link TrentoP#fAverageSlope} ).
     * <li>Diameter to verify (in verify mode), field of the property @see
     * {@link TrentoP#fDiameterToVerify}.
     * <li>Slope to verify (in verify mode),{@link #fVerifyPipeSlope} .
     * </ol>
     * </p>
     * <p>
    ...
    public void process() throws Exception {
        ...
        if (pTest == 1) {
            ...
            network = new NetworkCalibration.Builder(pm, networkPipes, dt, rainData, qOut, strBuilder)
            ...
            NetworkBuilder.Builder builder = new NetworkBuilder.Builder(pm, networkPipes, pN, pA, diameters, inPipesFC,
     ...
     * 
     * @throws IllegalArgumentException if the FeatureCollection hasn't the
     *         correct parameters.
     */
     ...
     * 
     * @param id the ID of this pipe.
     * @param cord the Coordinate of the link where drain.
     */
     ...
     * </p>
     * 
     * @param networkPipes the array which rappresent the net.
     * @param pm the progerss monitor.
     * @throws IllegalArgumentException if the net is unconsistent.
     */
