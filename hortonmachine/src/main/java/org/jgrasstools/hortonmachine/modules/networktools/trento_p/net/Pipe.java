...
public class Pipe {
     ...
     */
    private static double minimumDepth = DEFAULT_MINIMUM_DEPTH;
    /**
     * Max number of bisection to do in the solution of equationon.
     */
    private static int jMax = DEFAULT_J_MAX;
    /**
     * Minimum fill degree in the channel.
     */
    private static double minG = DEFAULT_MING;
    /**
     * Maximum Fill degree.
     */
    private static double maxTheta = DEFAULT_MAX_THETA;
    /**
     ...
     */
    private static int maxJunction = DEFAULT_MAX_JUNCTION;
    /**
     * Minimum discharge in a pipe.
     * 
     */
    private static double minDischarge = DEFAULT_MIN_DISCHARGE;
    /**
     ...
     * 
     */
    private static double c = DEFAULT_C;
    /**
    ...
    public static void setMaxJunction( int maxJunction ) {
        Pipe.maxJunction = maxJunction;
    }
    public static int getMaxJunction() {
        return maxJunction;
    }
    public static void setMinDischarge( double minDischarge ) {
        Pipe.minDischarge = minDischarge;
    }
    public static double getMinDischarge() {
        return minDischarge;
    }
    ...
    public static double getMaxTheta() {
        return maxTheta;
    }
    public static void setMaxTheta( double maxTheta ) {
        Pipe.maxTheta = maxTheta;
    }
    public static double getAccuracy() {
        return accuracy;
    }
    public static int getjMax() {
        return jMax;
    }
    ...
    public static void setAccuracy( double accuracy ) {
        Pipe.accuracy = accuracy;
    }
    public static void setMinimumDepth( double minimumDepth ) {
        Pipe.minimumDepth = minimumDepth;
    }
    public static void setJMax( int jMax ) {
        Pipe.jMax = jMax;
    }
    public static void setMinG( double minG ) {
        Pipe.minG = minG;
    }
     ...
     * </p>
     * 
     * @param pipeFeature the feature where the value are stored.
     * @param verify if the mode is project or verify.
     * @throws Exception if the featureCollection doesn't contains the field
     */
     ...
     * 
     * @param pipe the feature.
     * @param key the key string of the field.
     ...
     * 
     * 
     * @param diameters matrix with the commercial diameters.
     * @param tau tangential stress at the bottom of the pipe..
     * @param g fill degree.
     * @param maxd maximum diameter.
     * @param c is a geometric expression b/h where h is the height and b base
     ...
     * </p>
     * 
     * @param diameter matrice dei possibili diametri.
     * @param tau sforzo al fondo.
     * @param g grado di riempimento.
     * @param maxd massimo diametro
     * @param strWarnings a string which collect all the warning messages.
     */
     ...
     * </p>
     * 
     * @param diametrs matrice che contiene i diametri e spessori commerciali.
     * @param tau [Pa] Sforzo tangenziale al fondo che garantisca l'autopulizia
     *        della rete
     * @param dD
     * @param g Grado di riempimento da considerare nella progettazione della
     *        rete
     * @param maxd Diamtetro o altezza piu' grande adottato nei tratti piu' a
     *        monte
     * @param strWarnings a string which collect all the warning messages.
     */
     ...
     * 
     * @param diametrs matrice che contiene i diametri e spessori commerciali.
     * @param slope pendenza della tubazione.
     * @param dD spessore del tubo commerciale.
     * @param g Grado di riempimento da considerare nella progettazione della
     *        rete
     * @param maxd Diamtetro o altezza piu' grande adottato nei tratti piu' a
     *        monte
     ...
     * @param maxd Diamtetro o altezza piu' grande adottato nei tratti piu' a
     *        monte
     * @param c Rapporto base-altezza della sezione rettangolare.
     * @param strWarnings a string which collect all the warning messages.
     */
     ...
     * @param g Grado di riempimento da considerare nella progettazione della
     *        rete
     * @param maxd [cm] Diamtetro o altezza piu' grande adottati nei tratti piu'
     *        a monte
     * @param c Rapporto tra base e altezza nella sezione trapezoidale.
     */
     ...
     * </p>
     * 
     * @param slope [%] Pendenza del tratto da dimensionare, che e' pari a
     *        quella del terreno
     * @param g Grado di riempimento da considerare nella progettazione della
     *        rete
     * @param maxd [cm]Diamtetro o altezza piu' grande adottati nei tratti piu'
