...
public class TestKriging extends HMTestCase {
	...
	protected void setUp() throws Exception {
		...
		URL stazioniUrl = this.getClass().getClassLoader().getResource(
				"rainstations.shp");
		stazioniFile = new File(stazioniUrl.toURI());
		URL puntiUrl = this.getClass().getClassLoader().getResource(
				"basins_passirio_width0.shp");

		puntiFile = new File(puntiUrl.toURI());
		URL krigingRainUrl = this.getClass().getClassLoader().getResource(
				"rain_test.csv");
		krigingRainFile = new File(krigingRainUrl.toURI());

		URL krigingRain2Url = this.getClass().getClassLoader().getResource(
				"rain_test2A.csv");
		krigingRain2File = new File(krigingRain2Url.toURI());

		URL krigingRain3Url = this.getClass().getClassLoader().getResource(
				"rain_test3A.csv");
		...
		interpolatedRainPath = interpolatedRainPath.replaceFirst(
