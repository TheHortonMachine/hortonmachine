...
public class NumericsUtilities {
    ...
    public static boolean dEq( double a, double b ) {
        ...
        return a == b ? true : diffAbs < D_TOLERANCE ? true : diffAbs / Double.max(abs(a), abs(b)) < D_TOLERANCE;
    }
    ...
    public static boolean dEq( double a, double b, double epsilon ) {
        ...
        double diffAbs = abs(a - b);
        return a == b ? true : diffAbs < epsilon ? true : diffAbs / Double.max(abs(a), abs(b)) < epsilon;
    }
    ...
    public static boolean fEq( float a, float b ) {
        ...
        return a == b ? true : diffAbs < F_TOLERANCE ? true : diffAbs / Float.max(abs(a), abs(b)) < F_TOLERANCE;
    }
    ...
    public static boolean fEq( float a, float b, float epsilon ) {
        ...
        float diffAbs = abs(a - b);
        return a == b ? true : diffAbs < epsilon ? true : diffAbs / Float.max(abs(a), abs(b)) < epsilon;
    }
