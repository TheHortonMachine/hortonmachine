...
public class Lesto {
    ...
    private static Lesto lesto = null;

    private URL baseclassUrl;
    private Lesto( URL baseclassUrl ) {
     ...
     */
    public synchronized static Lesto getInstance() {
        if (lesto == null) {
     ...
     * 
     * <p>
     * <b>When this method is called, the {@link Lesto} instance is reset.</b>
     * </p>
     * <p>
